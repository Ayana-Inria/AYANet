...
gpu_ids=0
dataset_type=bcd
dataset_root=/mnt/c/Users/prisc/OneDrive\ -\ unige.it/Documents/Dataset/LEVIR/LEVIR-Cropped/
...
project_name=rep_AYANet_LEVIR_double_mtf2iadesv2_${encoder_arc}_${decoder_arc}_${split}_${val_split}_${optimizer}_e${epoch}_b${batch_size}_lr${lr}_newlrlambda
