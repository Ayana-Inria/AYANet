...
gpu_ids=0
dataset_type=bcd
dataset_root=./../../../Dataset/S2Looking/S2Looking-Cropped
...
project_name=rep_AYANet_S2Looking_double_mtf2iadesv2_${encoder_arc}_${decoder_arc}_${split}_${val_split}_${optimizer}_e${epoch}_b${batch_size}_lr${lr}_newlrlambda
