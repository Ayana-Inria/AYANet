...
class EfficientNet(nn.Module):
    def __init__(
        ...
        layers.append(
            Conv2dNormActivation(
                input_channel, firstconv_output_channels, kernel_size=3, stride=2, norm_layer=norm_layer, activation_layer=nn.SiLU
            )
        )
...
def efficientnet_ayn(
    *, weights = None, progress: bool = True, **kwargs: Any
    ...
    inverted_residual_setting, last_channel = _efficientnet_conf("efficientnet_ayn", width_mult=2.0, depth_mult=3.1)
    return _efficientnet(
        inverted_residual_setting,
        kwargs.pop("dropout", 0.5),
        last_channel,
...
def efficientnet_ayn2(
    *, weights = None, progress: bool = True, **kwargs: Any
) -> EfficientNet:

    inverted_residual_setting, last_channel = _efficientnet_conf("efficientnet_ayn2", width_mult=2.0, depth_mult=3.1)
    return _efficientnet(
        inverted_residual_setting,
        kwargs.pop("dropout", 0.5),
        last_channel,
